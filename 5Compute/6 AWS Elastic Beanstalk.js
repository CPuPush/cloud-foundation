...
* A managed service that automatically handles -
  * intrastructure provisioning and configuration
  * deploument
  * load balancing
  * automatic scaling
  * health monitoring
...
* No additional charge for Elastic Beanstalk
  * pay only for the underlying resourrces that are used
...
* It support web applications written from common platforms
